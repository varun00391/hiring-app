...
export default function Sidebar() {
  return (
    <aside className="glass-panel fixed inset-y-0 left-0 z-30 flex w-64 flex-col border-r border-slate-200/60 shadow-xl shadow-slate-200/20 dark:border-slate-800/60 dark:shadow-slate-950/40">
      <div className="flex h-[4.25rem] items-center gap-3 border-b border-slate-200/60 px-5 dark:border-slate-800/60">
        ...
        <div>
          <p className="text-sm font-bold tracking-tight text-slate-900 dark:text-slate-100">HireBot</p>
          <p className="text-[11px] font-medium text-slate-500 dark:text-slate-400">AI Recruiting Platform</p>
        </div>
      </div>
      ...
      <div className="border-t border-slate-200/60 p-4 dark:border-slate-800/60">
        <div className="rounded-xl bg-gradient-to-br from-indigo-50/90 via-violet-50/50 to-cyan-50/90 p-4 ring-1 ring-indigo-100/80 dark:from-indigo-950/50 dark:via-violet-950/30 dark:to-cyan-950/50 dark:ring-indigo-900/50">
