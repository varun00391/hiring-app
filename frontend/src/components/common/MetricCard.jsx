...
export default function MetricCard({
  ...
  return (
    <motion.div
      ...
      className={`group relative overflow-hidden rounded-2xl border border-slate-200/80 bg-white/80 p-5 shadow-sm backdrop-blur-sm transition-shadow duration-300 hover:shadow-xl dark:border-slate-700/80 dark:bg-slate-900/80 ${style.glow}`}
    >
