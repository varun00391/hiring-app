  ...
  return (
    <Card hover={false} padding="p-0" className="overflow-hidden">
      ...
      {uploads.length === 0 ? (
        ...
        <div className="custom-scrollbar max-h-[420px] divide-y divide-slate-100 overflow-y-auto">
          {uploads.map((item, index) => (
            ...
            >
              <div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-xl bg-gradient-to-br from-indigo-100 to-violet-100 text-sm font-bold text-indigo-700 ring-2 ring-white">
